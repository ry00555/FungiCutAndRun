#!/bin/bash
#SBATCH --job-name=SET7_MSA
#SBATCH --partition=batch
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=150gb
#SBATCH --time=12:00:00
#SBATCH --output=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/SET7_MSA.%A_%a.out
#SBATCH --error=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/SET7_MSA.%A_%a.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=ry00555@uga.edu

# ══════════════════════════════════════════════════════════════════════
# SET7_AF3_MSA_Pool.sh — MSA (data pipeline only) for one SET7 pool
# per array task. Submitted by SET7_AF3_Pools.sh with --array=N-M%THROTTLE
# ══════════════════════════════════════════════════════════════════════
