...
plotHeatmap --matrixFile "${OUTDIR}/Matrices/rtt109_H3K27me3_Run133Only2_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/rtt109_H3K27me3_Run133Only2_kmeans2.png" --samplesLabel WT 133-90 133-81 --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2
...
plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_13225_3_13152WT_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_13225_3_13152WT_kmeans2.png" --samplesLabel WT 132-25   --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2
