...
#  plotHeatmap --matrixFile "${OUTDIR}/Matrices/NCU00423_H3K27me3.gz" --outFileName "${OUTDIR}/Heatmaps/NCU00423_H3K27me3_hclust_kmeans.png" --samplesLabel WT NCU00423-KO --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2
...
#NCU00423 H3K27me3
#computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S "${OUTDIR}/BigWigs/133-90_ChIP_WT_H3K27me3_Rep1_S87_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw" ${OUTDIR}/BigWigs/128-53_ChIP_-NCU00423__hph_H3K27me3_Rep1_S32_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-30_ChIP_ncu00423_H3K27me3_Rep_1_S27_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-34_ChIP_ncu00423_Input_Rep_1_S31_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-35_ChIP_ncu00423_H3K27me3_Rep_1_S32_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/NCU00423_H3K27me3_Pool2_kmeans2.gz"
#plotHeatmap --matrixFile "${OUTDIR}/Matrices/NCU00423_H3K27me3_Pool2_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/NCU00423_H3K27me3_Pool2_kmeans2.png" --samplesLabel WT 128-53 131-52 132-30 132-34  --kmeans 2 --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1
...
#rtt109 by Run
#H3K27me3
#computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/133-90_ChIP_WT_H3K27me3_Rep1_S87_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/131-64_ChIP_ncu00548_H3K27me3_Rep1_S52_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/rtt109_H3K27me3_Run131Only2_kmeans2.gz"
#  plotHeatmap --matrixFile "${OUTDIR}/Matrices/rtt109_H3K27me3_Run131Only2_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/rtt109_H3K27me3_Run131Only2_kmeans2.png" --samplesLabel WT 131-64 --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2
...
plotHeatmap --matrixFile "${OUTDIR}/Matrices/rtt109_H3K27me3_Run133Only2_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/rtt109_H3K27me3_Run133Only2_kmeans2.png" --samplesLabel WT rtt109-KO --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2
...
#computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/133-91_ChIP_WT_H3K36me3_Rep1_S88_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/133-82_ChIP_rtt109_hph_H3K36me3_Rep1_S79_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/heatmapPRC2genes.bed" --skipZeros -o "${OUTDIR}/Matrices/rtt109_H3K36me3_Run133Only3_PRC2Genes.gz"
#plotHeatmap --matrixFile "${OUTDIR}/Matrices/rtt109_H3K36me3_Run133Only3_PRC2Genes.gz" --outFileName "${OUTDIR}/Heatmaps/rtt109_H3K36me3_Run133Only3_PRC2Genes.png" --samplesLabel WT 133-82 --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1
...
#computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/131-52_ChIP_WT_H3K27me3_Rep1_S40_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw  ${OUTDIR}/BigWigs/134-14_ChIP_ncu06788_H3K27me3_Rep2.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/ncu06788_H3K27me3_13414_2_kmeans2.gz"
#plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_13414_2_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_13414_2_kmeans2.png" --samplesLabel WT 134-14  --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2

computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/133-90_ChIP_WT_H3K27me3_Rep1_S87_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-25_ChIP_ncu06787_H3K27me3_Rep_1_S22_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/ncu06788_H3K27me3_13225_3_13152WT_kmeans2.gz"
plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_13225_3_13152WT_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_13225_3_13152WT_kmeans2.png" --samplesLabel WT NCU06788-KO --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2

#computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/133-90_ChIP_WT_H3K27me3_Rep1_S87_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/134-14_ChIP_ncu06788_H3K27me3_Rep2.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-25_ChIP_ncu06787_H3K27me3_Rep_1_S22_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/ncu06788_H3K27me3_Pool_3_13152WT_kmeans2.gz"
#plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_Pool_3_13152WT_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_Pool_3_13152WT_kmeans2.png" --samplesLabel WT 134-14 132-25  --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2

#K27me3 pooled
#computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/133-90_ChIP_WT_H3K27me3_Rep1_S87_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-25_ChIP_ncu06787_H3K27me3_Rep_1_S22_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/134-14_ChIP_ncu06788_H3K27me3_Rep2.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/ncu06788_H3K27me3_Pool2_kmeans2.gz"
#plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_Pool2_kmeans2.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_Pool2_kmeans2.png" --samplesLabel WT 132-25 134-14  --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans 2
...
#plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K36me3_Pool4.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K36me3_Pool4.png" --samplesLabel WT 132-27 134-12  --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1
