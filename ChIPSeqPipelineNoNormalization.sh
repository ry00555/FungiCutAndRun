...
computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/131-52_ChIP_WT_H3K27me3_Rep1_S40_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-25_ChIP_ncu06787_H3K27me3_Rep_1_S22_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/ncu06788_H3K27me3_13225_3.gz"
plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_13225_3_13152WT.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_13225_3.png" --samplesLabel WT 132-25   --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1

computeMatrix reference-point --referencePoint TSS -b 1500 -a 1500 -S ${OUTDIR}/BigWigs/131-52_ChIP_WT_H3K27me3_Rep1_S40_L001_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/134-14_ChIP_ncu06788_H3K27me3_Rep2.bin_25.smooth_75Bulk.bw ${OUTDIR}/BigWigs/132-25_ChIP_ncu06787_H3K27me3_Rep_1_S22_R1_001_val_1.fq.gz.bin_25.smooth_75Bulk.bw -R "/scratch/ry00555/neurospora.bed" --skipZeros -o "${OUTDIR}/Matrices/ncu06788_H3K27me3_Pool_3.gz"
plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K27me3_Pool_3_13152WT.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_Pool_3.png" --samplesLabel WT 134-14 132-25  --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1 --kmeans2
