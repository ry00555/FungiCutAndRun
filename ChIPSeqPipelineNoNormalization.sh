...
plotHeatmap --matrixFile "${OUTDIR}/Matrices/ncu06788_H3K36me3_Pool_1stsetPRC2target.gz" --outFileName "${OUTDIR}/Heatmaps/ncu06788_H3K27me3_Pool_1stsetPRC2target.png" --samplesLabel WT 132-27 134-12  --hclust 1 --colorMap Reds --sortRegions descend --missingDataColor white --sortUsingSamples 1
