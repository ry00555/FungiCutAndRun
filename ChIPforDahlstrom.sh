...
#done
findPeaks "${TAGDIR}/135-41_ChIP_WT_Anti6xHis_Rep1_S38" -style factor  -o "${PEAKSDIR}/135-41_ChIP_WT_Anti6xHis_Rep1_S38_peaks.txt" -i "${TAGDIR}/135-44_ChIP_WT_Input_Rep1_S41" -F 1 -p 0.01
findPeaks "${TAGDIR}/135-43_ChIP_hcra6xhis_Anti6xHis_Rep1_S40" -style factor  -o "${PEAKSDIR}/135-43_ChIP_hcra6xhis_Anti6xHis_Rep1_S40_peaks.txt" -i "${TAGDIR}/135-46_ChIP_hcra6xhis_Input_Rep1_S43" -F 1 -p 0.01 
