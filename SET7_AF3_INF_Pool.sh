...
#SBATCH --mem=60gb
#SBATCH --time=4:00:00
#SBATCH --output=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/SET7_INF.%A_%a.out
#SBATCH --error=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/SET7_INF.%A_%a.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=ry00555@uga.edu

# ══════════════════════════════════════════════════════════════════════
# SET7_AF3_INF_Pool.sh — inference for one SET7 pool per array task.
# Submitted by SET7_AF3_Pools.sh (inf_scan/recheck modes) with --array=...
...
# INF_THROTTLE / INF_BATCH comments in SET7_AF3_Pools.sh before changing.
# ══════════════════════════════════════════════════════════════════════
