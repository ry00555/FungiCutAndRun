...
#input file variables
  read1="${fastqPath}/${accession}*_L007_R1_001.fastq.gz"
  read2="${fastqPath}/${accession}*_L007_R2_001.fastq.gz"
...
base=$(basename "${bam}" _Q30.bam)
Input="${bamdir}/${base}Input_Q30.bam"

   macs3 callpeak -t "${bam}" -f BAMPE -n "${accession}" -c "${Input}" --broad -g 41037538 --broad-cutoff 0.1 --outdir "${PeakDir}" --min-length 800 --max-gap 500 --nolambda
done
