#!/bin/bash
#SBATCH --job-name=SUZ12_MSA
#SBATCH --partition=batch
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=150gb
#SBATCH --time=12:00:00
#SBATCH --output=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/SUZ12_MSA.%A_%a.out
#SBATCH --error=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/SUZ12_MSA.%A_%a.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=ry00555@uga.edu

# ══════════════════════════════════════════════════════════════════════
# SUZ12_AF3_MSA_Pool.sh — MSA (data pipeline only) for one SUZ12 pool
# per array task. Submitted by SUZ12_AF3_Pools.sh with --array=N-M%THROTTLE
# ══════════════════════════════════════════════════════════════════════
