#!/bin/bash
#SBATCH --job-name=EED_MSA
#SBATCH --partition=batch
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=150gb
#SBATCH --time=12:00:00
#SBATCH --output=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/EED_MSA.%A_%a.out
#SBATCH --error=/scratch/ry00555/RNASeqPaper2026/Proteome/SingleBaitPools/logs/EED_MSA.%A_%a.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=ry00555@uga.edu

# ══════════════════════════════════════════════════════════════════════
# EED_AF3_MSA_Pool.sh — MSA (data pipeline only) for one EED pool
# per array task. Submitted by EED_AF3_Pools.sh with --array=N-M%THROTTLE
# ══════════════════════════════════════════════════════════════════════
