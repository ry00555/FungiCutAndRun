...
plotHeatmap -m $OUTDIR/Heatmaps/K27_K36onK27genes_ModsTogether_n573.gz -o $OUTDIR/Heatmaps/K27_K36onK27genes_ModsTogether_n573_sortRTT109.png --sortRegions descend --sortUsingSamples 2 --startLabel "5'" --endLabel "3'" --heatmapHeight 8 --heatmapWidth 3 --whatToShow "heatmap and colorbar" --boxAroundHeatmaps no --samplesLabel "WT 153-124" "∆rtt109 153-126" "rtt109-3xflag K27me3" "WT K36me3" "∆rtt109 K36me3" "rtt109-3xflag K36me3"  --colorMap  'Greens' 'Greens' 'Greens' 'YlOrBr' 'YlOrBr' 'YlOrBr' -max 15 15 15 10 10 10 --outFileSortedRegions $OUTDIR/Heatmaps/K27_K36onK27genes_ModsTogether_n573_rtt1-0.bed --outFileNameMatrix $OUTDIR/Heatmaps/K27_K36onK27genes_ModsTogether_n573_sortRTT109.tab
