...
#computeMatrix scale-regions -p 12 -R "$OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered.bed" -S $BWDIR/153-124_ChIP_WT_H3K27me3_.bin_25.smooth_50Bulk.bw $BWDIR/153-126_ChIP_rtt109_H3K27me3_.bin_25.smooth_50Bulk.bw /scratch/ry00555/RTT109PaperFigures/BigWigs/150-81_ChIP_rtt109FLAG_H3K27me3__S81_L002_R1_001_val_1.fq.gz.bin_25.smooth_50_Q30.bw --skipZeros -b 500 -a 500 --sortUsingSamples 2 --sortRegions descend -o $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered_V2.gz --outFileNameMatrix $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered_V2.tab

#plotHeatmap -m $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered_V2.gz -o $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered_V2.png --sortRegions descend --sortUsingSamples 1 --heatmapHeight 8  --heatmapWidth 3  --outFileSortedRegions $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered_V3.bed  --startLabel "5'"  --endLabel "3'" --boxAroundHeatmaps no  --samplesLabel  "WT 153-124" "∆rtt109 153-126"  "rtt109-3xflag 150-81" --colorMap 'Greens'  -max 15 15 15
