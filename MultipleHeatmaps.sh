...
computeMatrix reference-point -p 12 -R "$OUTDIR/Heatmaps/K27_K36_onK27genes_cluster2_V1_sorted_filtered.bed" -S $BWDIR/153-124_ChIP_WT_H3K27me3_.bin_25.smooth_50Bulk.bw $BWDIR/153-126_ChIP_rtt109_H3K27me3_.bin_25.smooth_50Bulk.bw $BWDIR/150-62_WT_H3K36me3_rep8.bin_25.smooth_50.bw $BWDIR/150-70_rtt109_H3K36me3_rep7.bin_25.smooth_50.bw  -o $OUTDIR/Heatmaps/K27_K36_onK27genes_cluster2_V1_sorted_filtered.gz --outFileNameMatrix $OUTDIR/Heatmaps/K27_K36_onK27genes_cluster2_V1_sorted_filtered.tab 	--sortRegions keep  --missingDataAsZero -bs 10 -a 2000 -b 1000

plotHeatmap -m $OUTDIR/Heatmaps/K27_K36_onK27genes_cluster2_V1_sorted_filtered.gz -o $OUTDIR/Heatmaps/K27_K36_onK27genes_cluster2_V1_sorted_filtered.png --sortRegions descend --sortUsingSamples 2 --outFileSortedRegions $OUTDIR/Heatmaps/K27_K36_onK27genes_cluster2_V1_sorted_filtered.bed --startLabel "5'" --endLabel "3'" --heatmapHeight 8 --heatmapWidth 4  --boxAroundHeatmaps no --samplesLabel "WT 153-124" "∆rtt109 153-126"  "WT K36me3" "∆rtt109 K36me3"  --colorMap  'Greens' 'Greens' 'YlOrBr' 'YlOrBr' --hclust 2
