...
plotHeatmap -m $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_peaks_V1_sorted_filtered_V3.gz -o $OUTDIR/Heatmaps/RTT109_K27domains_MyceliaK27me3_121725n304_V2.png --sortRegions descend --sortUsingSamples 2 --heatmapHeight 6  --heatmapWidth 2  --outFileSortedRegions $OUTDIR/Heatmaps/RTT109_K27domains_V1_n304.bed  --startLabel "5'"  --endLabel "3'" --boxAroundHeatmaps no  --samplesLabel  "WT 153-124" "∆rtt109 153-126"  "rtt109-3xflag 150-81" --colorMap 'Greens'  -max 15 15 15
