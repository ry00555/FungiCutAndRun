...
plotHeatmap -m $OUTDIR/Heatmaps/K27_K36onK27genes_StrainsTogether_n642.gz -o $OUTDIR/Heatmaps/K27_K36onK27genes_StrainsTogether_n642.png --sortRegions descend --sortUsingSamples 3 --outFileSortedRegions $OUTDIR/Heatmaps/K27_K36onK27genes_StrainsTogether_n642_sorted.bed --startLabel "5'" --endLabel "3'" --heatmapHeight 6 --heatmapWidth 3 --whatToShow "heatmap and colorbar" --boxAroundHeatmaps no --samplesLabel "WT 153-124" "WT K36me3" "∆rtt109 153-126" "∆rtt109 K36me3" "rtt109-3xflag K27me3" "rtt109-3xflag K36me3"  --colorMap  'Greens' 'YlOrBr' 'Greens' 'YlOrBr' 'Greens' 'YlOrBr' -max 15 10 15 10 15 10
